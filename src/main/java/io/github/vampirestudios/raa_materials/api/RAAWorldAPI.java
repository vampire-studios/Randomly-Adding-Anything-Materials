...
public class RAAWorldAPI {
    ...
    public static void generateOresForTarget(OreTarget target) {
        Materials.MATERIALS.forEach(material -> {
            Feature<OreFeatureConfig> oreFeature = BiomeUtils.newFeature(Utils.appendToPath(material.getId(), "_ore_feature"), new OreFeature(OreFeatureConfig.CODEC));
            ...
            ConfiguredFeature<?, ?> configuredOreFeature = BiomeUtils.newConfiguredFeature(registryKey.getValue(), oreFeature.configure(new OreFeatureConfig(target.getTest(),
